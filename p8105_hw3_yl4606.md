...
```
    ...
    ## # A tibble: 50,400 x 6
    ## # Groups:   day_id [35]
    ##    day_id  week day    weekday_vs_weekend minute activity
...
The existing variables include day\_id, week, day, weekday\_vs\_weekend,
minute, activity, and the size of dataset is 50400 rows by 6 columns.
Therefore, there are 50400 observations.
